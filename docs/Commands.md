...
PwmFrequency<a class="cmnd" id="pwmfrequency"></a>|`1` = reset PWM frequency to 223Hz<BR>`40..4000 or 40..50000` = set PWM frequency <BR>(40Hz to 4kHz on ESP 82xx / 40Hz to 50kHz on ESP32)<BR>_As of v8.3.0 the default frequency changed to 977Hz_
